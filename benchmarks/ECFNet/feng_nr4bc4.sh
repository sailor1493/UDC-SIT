#!/bin/bash
#SBATCH --job-name feng-best-nr4bc4
#SBATCH --partition AMD
#SBATCH --output logs/feng-best-%j.log
#SBATCH --error logs/feng-best-%j.err
#SBATCH --gres=gpu:4
...
base_dir=/shared/s1/lab08/udc/Feng-S
...
wandb_name="Feng-S-Level5-nr4-bc4"
step_1="${wandb_name}-1"
step_2="${wandb_name}-2"
step_3="${wandb_name}-3"
